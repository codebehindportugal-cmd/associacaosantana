        ...
        <div class="grid gap-4 lg:grid-cols-[3fr_2fr]">
            ...
            <aside class="rounded-lg bg-gray-800 p-4">
                ...
                <div v-else>
                    ...
                    <div class="space-y-3">
                        <div v-for="item in pedido.items" :key="item.id" class="rounded-lg border bg-gray-900 p-3" :class="item.prioridade ? 'animate-pulse border-red-500' : 'border-gray-700'">
                            ...
                            <div class="mt-3 flex items-center justify-between gap-2">
                                ...
                                <button class="rounded px-3 py-2 font-black" :class="item.prioridade ? 'bg-red-600' : 'bg-gray-700'" @click="urgente(item)">⚡</button>
                            </div>
                        </div>
                    </div>
