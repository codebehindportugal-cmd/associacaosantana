    ...
    <PublicShell>
        <main class="py-20 bg-amber-50">
            <article class="mx-auto max-w-4xl px-5 lg:px-8">
                ...
                <h1 class="mt-3 text-4xl font-bold text-stone-800">{{ content.hero_titulo || 'Política de Cookies' }}</h1>
                ...
                <div class="mt-10 rounded-xl border border-amber-200 bg-white p-6">
                    <h2 class="text-2xl font-bold text-stone-800">Privacidade</h2>
                    <p class="mt-3 text-stone-600">Consulte também a <Link :href="route('legal.privacidade')" class="font-semibold text-amber-700 hover:text-amber-900 transition underline">Política de Privacidade</Link>.</p>
                </div>
            </article>
        </main>
    </PublicShell>
