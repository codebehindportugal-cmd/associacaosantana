...
<template>
    <AppLayout>
        ...
        <form class="grid max-w-3xl gap-4 rounded-lg bg-white p-6 shadow-sm md:grid-cols-2" @submit.prevent="submit">
            <input v-model="form.numero_socio" class="rounded-md border-slate-300 bg-white text-stone-900" placeholder="Número">
            <input v-model="form.nome" class="rounded-md border-slate-300 bg-white text-stone-900" placeholder="Nome">
            <input v-model="form.email" class="rounded-md border-slate-300 bg-white text-stone-900" placeholder="Email">
            <input v-model="form.telefone" class="rounded-md border-slate-300 bg-white text-stone-900" placeholder="Telefone">
            <input v-model="form.data_nascimento" type="date" class="rounded-md border-slate-300 bg-white text-stone-900">
