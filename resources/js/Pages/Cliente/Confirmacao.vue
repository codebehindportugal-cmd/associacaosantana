    ...
    <main class="min-h-screen bg-slate-950 px-4 py-6 text-white">
        <section class="mx-auto max-w-xl">
            <div class="rounded-3xl bg-white p-6 text-center text-slate-950 shadow-sm">
                <div class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-emerald-100 text-xl font-black text-emerald-700">OK</div>
            ...
            <div class="mt-5 rounded-3xl bg-white p-5 text-slate-950 shadow-sm">
                <h2 class="mb-3 text-lg font-black">Produtos enviados</h2>
                <div class="mb-3 rounded-2xl bg-amber-100 p-4 text-sm font-black text-amber-900">
                    Se se enganou no pedido, chame um funcionário para ajudar.
                </div>
