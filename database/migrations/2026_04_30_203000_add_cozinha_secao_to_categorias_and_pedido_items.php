...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE categorias MODIFY secao ENUM('bebidas', 'acompanhamentos', 'sobremesas') NOT NULL");
        DB::statement("ALTER TABLE pedido_items MODIFY secao ENUM('bebidas', 'acompanhamentos', 'sobremesas') NOT NULL");
    }
};
